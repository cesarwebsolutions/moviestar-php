<?php
    ...
    $fantasiaMovies = $movieDao->getMoviesByCategory("Fantásia");
...
?>
    <div class="container-fluid" id="main-container">
        ...
        <div class="movies-container">
            ...
            <h2 class="section-title">Fantásia</h2>
            <p class="section-description">Veja os melhores filmes de fantásia</p>
            <div class="movies-container">
